...
server/ems: common/io.o common/constants.h server/main.c server/operations.o server/eventlist.o server/parser.o
	$(CC) $(CFLAGS) $(SLEEP) -o $@ $^
...
clean:
	rm -f common/*.o client/*.o server/*.o server/ems client/client jobs/*.out
